...
from models import linear_model_all_have_past, flexible_model, flexible_model_separate_times
import random
import time
...
for single_input in input_rain:
    ...
    input_rain_meno_1[index_rain] = [input_rain[index_rain][0]] + input_rain[index_rain][:len(input_rain[index_rain])-1]
    index_rain += 1
...
for single_input in input_rain_val:
    ...
    input_rain_meno_1_val[index_rain] = [input_rain_val[index_rain][0]] + input_rain_val[index_rain][:len(input_rain_val[index_rain])-1]
    index_rain += 1
...
data_try = list(zip(input_rain[index_pluviometer], input_rain_meno_1[index_pluviometer], input_paderno,
                    input_paderno_meno_1, input_niguarda, input_niguarda_meno_1, input_cantu, input_cantu_meno_1,
                    output_niguarda))
random.shuffle(data_try)
input_rain_try, input_rain_meno_1_try, input_paderno_try, input_paderno_meno_1_try, input_niguarda_try, \
            input_niguarda_meno_1_try, input_cantu_try, input_cantu_meno_1_try, output_niguarda_try = zip(*data_try)

input_rain_try            = list(input_rain_try)
input_rain_meno_1_try     = list(input_rain_meno_1_try)
input_paderno_try         = list(input_paderno_try)
input_paderno_meno_1_try  = list(input_paderno_meno_1_try)
...
input_cantu_meno_1_try    = list(input_cantu_meno_1_try)
output_niguarda_try       = list(output_niguarda_try)

# RANDOMIZE DATA VALIDATION

data_val_try = list(zip(input_rain_val[index_pluviometer], input_rain_meno_1_val[index_pluviometer], input_paderno_val,
                        input_paderno_meno_1_val, input_niguarda_val, input_niguarda_meno_1_val, input_cantu_val,
                        input_cantu_meno_1_val, output_niguarda_val))
random.shuffle(data_val_try)
input_rain_val_try, input_rain_meno_1_val_try, input_paderno_val_try, input_paderno_meno_1_val_try, \
        input_niguarda_val_try, input_niguarda_meno_1_val_try, input_cantu_val_try, input_cantu_meno_1_val_try, \
        output_niguarda_val_try = zip(*data_val_try)

input_rain_val_try            = list(input_rain_val_try)
input_rain_meno_1_val_try     = list(input_rain_meno_1_val_try)
input_paderno_val_try         = list(input_paderno_val_try)
input_paderno_meno_1_val_try  = list(input_paderno_meno_1_val_try)
...
input_cantu_meno_1_val_try    = list(input_cantu_meno_1_val_try)
output_niguarda_val_try       = list(output_niguarda_val_try)

# MODELS
"""
flexible_inputs = [input_rain_try, input_niguarda_try, input_niguarda_meno_1_try, input_paderno_try, input_cantu_try,
                   input_rain_meno_1_try, input_niguarda_meno_1_try, input_niguarda_meno_1_try, input_paderno_meno_1_try, input_cantu_meno_1_try]

model = flexible_model_separate_times.LinearModel(len(flexible_inputs), 2)

history = model.fit(x=flexible_inputs, y=output_niguarda_try, epochs=100, verbose=2, validation_split=None,
                    validation_data=([input_rain_val_try, input_niguarda_val_try, input_niguarda_meno_1_val_try, input_paderno_val_try, input_cantu_val_try,
                                      input_rain_meno_1_val_try, input_niguarda_meno_1_val_try, input_niguarda_meno_1_val_try,
                                      input_paderno_meno_1_val_try, input_cantu_meno_1_val_try], output_niguarda_val_try))

predictions = model.predict(x=[input_rain_val_try, input_niguarda_val_try, input_niguarda_meno_1_val_try, input_paderno_val_try, input_cantu_val_try,
                                      input_rain_meno_1_val_try, input_niguarda_meno_1_val_try, input_niguarda_meno_1_val_try,
                                      input_paderno_meno_1_val_try, input_cantu_meno_1_val_try])



"""
# FLEXIBLE MODEL
flexible_inputs = [input_rain_try, input_niguarda_try, input_niguarda_meno_1_try, input_paderno_try,
                   input_cantu_try]

model = flexible_model.LinearModel(len(flexible_inputs))

history = model.fit(x=flexible_inputs, y=output_niguarda_try, epochs=100, verbose=2, validation_split=None,
                    validation_data=([input_rain_val_try, input_niguarda_val_try, input_niguarda_meno_1_val_try,
                                      input_paderno_val_try, input_cantu_val_try], output_niguarda_val_try))

predictions = model.predict(x=[input_rain_val_try, input_niguarda_val_try, input_niguarda_meno_1_val_try,
                                      input_paderno_val_try, input_cantu_val_try])

"""
good
flexible_inputs = [input_rain_try, input_paderno_try, input_paderno_meno_1_try,
                    input_niguarda_try, input_niguarda_meno_1_try]

model = flexible_model.LinearModel(len(flexible_inputs))

history = model.fit(x=flexible_inputs, y=output_niguarda_try, epochs=100, verbose=2, validation_split=None,
                    validation_data=([input_rain_val_try, input_paderno_val_try, input_paderno_meno_1_val_try,
                                      input_niguarda_val_try, input_niguarda_meno_1_val_try], output_niguarda_val_try))
                                      
predictions = model.predict(x=[input_rain_val_try, input_paderno_val_try,
                    input_paderno_meno_1_val_try, input_niguarda_val_try, input_niguarda_meno_1_val])
"""
...
model = linear_model_all_have_past.LinearModel()

history = model.fit(x=[input_rain_try, input_rain_meno_1_try, input_paderno_try, input_paderno_meno_1_try,
                    input_niguarda_try, input_niguarda_meno_1_try, input_cantu_try, input_cantu_meno_1_try],
                    y=output_niguarda_try, epochs=100, verbose=2, validation_split=None,
                    validation_data=([input_rain_val_try, input_rain_meno_1_val_try, input_paderno_val_try,
                    input_paderno_meno_1_val_try, input_niguarda_val_try, input_niguarda_meno_1_val_try,
                    input_cantu_val_try, input_cantu_meno_1_val_try], output_niguarda_val_try))


predictions = model.predict(x=[input_rain_val_try, input_rain_meno_1_val_try, input_paderno_val_try,
                    input_paderno_meno_1_val_try, input_niguarda_val_try, input_niguarda_meno_1_val_try,
                    input_cantu_val_try, input_cantu_meno_1_val_try])
