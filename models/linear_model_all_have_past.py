...
class LinearModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        rain_input_minus_1 = Input(shape=(1,), name='rain_input_minus_1')

        paderno_input = Input(shape=(1,), name='paderno_input')
        paderno_input_minus_1 = Input(shape=(1,), name='paderno_input_minus_1')
        ...
        cantu_input_minus_1 = Input(shape=(1,), name='cantu_input_minus_1')


        x = concatenate([rain_input, rain_input_minus_1, paderno_input, paderno_input_minus_1, niguarda_input,
                         niguarda_input_minus_1, cantu_input, cantu_input_minus_1])
        ...
        self.model = Model(inputs=[rain_input, rain_input_minus_1, paderno_input, paderno_input_minus_1, niguarda_input,
                                   niguarda_input_minus_1, cantu_input, cantu_input_minus_1], outputs=main_output)
    ...
    def fit(self, x, y, epochs, verbose, validation_split, validation_data):
        ...
        history_file = self.model.fit(x=x, y=y, batch_size=None, epochs=epochs, verbose=verbose,
                              callbacks=[early_stop, history], validation_split=validation_split,
