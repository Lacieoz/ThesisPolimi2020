...
class LinearModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        x = concatenate([rain_input, paderno_input, niguarda_input, cantu_input])
        ...
        self.model = Model(inputs=[rain_input, paderno_input, niguarda_input, cantu_input], outputs=main_output)
    ...
    def fit(self, x, y, epochs, verbose, validation_split, validation_data):
        ...
        history_file = self.model.fit(x=x, y=y, batch_size=None, epochs=epochs, verbose=verbose, callbacks=[early_stop, history],
                       validation_split=validation_split, validation_data=validation_data, shuffle=True)
